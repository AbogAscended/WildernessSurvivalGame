...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument('--target-kl', type=float, default=0.015, help='Target KL divergence for adaptive scheduler.')

    # Env
    p.add_argument('--difficulty', type=str, default='easy', choices=['easy', 'medium', 'hard', 'extreme', 'normal'])
